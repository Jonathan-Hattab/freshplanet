...
public class Square extends JLabel{
	...
	/**
	 * This method defines what happens when the case is left-clicked.
	 */
	public void click(){
		this.shown = true;
		...
		// Increment the total shown cases. It also checks if the game is over.
	...
	// ----------------- GAME LISTENER ------------------
	/**
	 * This intern class defines the way the cases react when they are clicked.
	 * @author jonathanhattab
	 *
	 */
